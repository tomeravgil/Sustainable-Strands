...
export default function Home() {
  return (
    <main className="">
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-r from-purple-300 via-pink-300 to-red-300 opacity-70 blur-2xl"></div> */}
      <GoogleGeminiEffectDemo/>
      <div className="flex item-center justify-evenly items-center">
        <FlipWordsDemo/>
        <CardStackDemo/>
      </div>
...
const CARDS = [
  {
    id: 0,
    name: "HempCrete",
    designation: "Concrete Created From Hemp",
    content: (
      <p>
...
const Strands = ({
  ...
  let v = `0 0 ${window.screen.width} ${window.screen.height}`;
  ...
  return (
    <div className={cn("sticky top-80 w-screen", className)}>
      ...
      <div className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        Sustainable Strands is here to transform the future of Hemp 
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative w-full boder border-transparent dark:bg-black dark:border-white/[0.2] shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
...
export function HoverBorderGradientDemo() {
  return (
      <HoverBorderGradient
        ...
        as="button"
        className="dark:bg-black  text-neutral-400 dark:text-white flex items-center text-sm transition ease-in hover:text-text delay-100"
        duration={.25}
      >
